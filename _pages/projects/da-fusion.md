...
<div class="project-page">
  ...
  <div class="pp-teaser pp-figure pp-figure--md">
    <p class="pp-note"><em>TODO: add a teaser image to assets/img/projects/da-fusion/ and swap in a figure.liquid include here (see seg2grasp.md).</em></p>
  </div>
  ...
  <section class="pp-section" id="abstract">
    <h2>Abstract</h2>
    <p><em>TODO: paste the paper's abstract here.</em></p>
  </section>

  <section class="pp-section" id="method">
    <h2>Method</h2>
    <p><em>TODO: method figure(s) + description.</em></p>
  </section>
